 ...
 */
export const TikTokLogo = ({ size = 24 }) => (
 ...
 * @param {number} size - Size of the icon in pixels (default: 24)
 */
export const InstagramLogo = ({ size = 24 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
 ...
 * @param {number} size - Size of the icon in pixels (default: 24)
 */
export const FacebookLogo = ({ size = 24 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
 ...
 * @param {number} size - Size of the icon in pixels (default: 24)
 */
export const LinkedInLogo = ({ size = 24 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
 ...
 * @param {number} size - Size of the icon in pixels (default: 24)
 */
export const TwitterLogo = ({ size = 24 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
